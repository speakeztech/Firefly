...
module TypedPatterns =
    ...
    // Create a mutable pattern registry to break circular reference
    let mutable patternRegistry : MLIRPattern list = []
    
    /// Forward declaration of pattern processing function
    ...
    // Now define all the pattern implementations
